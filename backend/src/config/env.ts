...
const envSchema = z.object({
  ...
  SUPER_ADMIN_USERNAME: z.string().trim().min(3).max(100).default('Gac_Superadmin_Maula'),
  SUPER_ADMIN_PASSWORD_HASH: z.string().trim().min(20).default('$argon2id$v=19$m=65536,t=3,p=1$W+F/BxtZ/d7s+amoGFI36g==$uIpOOgYeGMkwmbclfqOPN8xyrgzNgynzW5lwLHWMKME='),
